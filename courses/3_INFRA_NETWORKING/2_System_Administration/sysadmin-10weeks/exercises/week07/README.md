# Bài tập tuần 7: Kế hoạch Active Directory

Hoàn thiện `starter.ps1` trong VM lab hoặc container riêng. Mặc định script phải chỉ đọc/dry-run; mọi thay đổi cần cờ `--apply`, xác nhận đầu vào, backup và rollback.
