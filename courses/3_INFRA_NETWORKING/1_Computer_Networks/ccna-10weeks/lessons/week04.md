# Tuần 4: Định tuyến IP (IP Routing) cơ bản

## 1. Lý Thuyết
- Khái niệm: Định tuyến IP cơ bản, Định tuyến tĩnh (Static Routing), Default Route, Inter-VLAN Routing (Router-on-a-stick).
