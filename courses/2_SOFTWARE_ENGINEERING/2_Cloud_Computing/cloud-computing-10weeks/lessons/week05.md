# Tuần 5: Container hóa với Docker

## Mục tiêu

- Hiểu và giải thích được image layer, Dockerfile, healthcheck, Compose, volume và network.
...
image layer, Dockerfile, healthcheck, Compose, volume và network. Mọi thao tác có thể tạo chi phí hoặc thay đổi hạ tầng phải đi qua bước review, dry-run/plan và nguyên tắc quyền tối thiểu. Không lưu secret trong Git.

## Code mẫu

- [Mở week05.sh](../code/week05.sh)
- Chạy: `bash code/week05.sh`
