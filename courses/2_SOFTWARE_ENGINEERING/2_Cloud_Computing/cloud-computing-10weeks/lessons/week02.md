# Tuần 2: Linux server và Bash an toàn

## Mục tiêu

- Hiểu và giải thích được SSH, user/group, quyền file, process, disk và script idempotent.
...
SSH, user/group, quyền file, process, disk và script idempotent. Mọi thao tác có thể tạo chi phí hoặc thay đổi hạ tầng phải đi qua bước review, dry-run/plan và nguyên tắc quyền tối thiểu. Không lưu secret trong Git.

## Code mẫu

- [Mở week02.sh](../code/week02.sh)
- Chạy: `bash code/week02.sh`
