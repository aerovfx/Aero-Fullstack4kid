# Tuần 8: Helm và triển khai Kubernetes

## Mục tiêu

- Hiểu và giải thích được chart, values, template, release và kiểm tra trước khi deploy.
...
chart, values, template, release và kiểm tra trước khi deploy. Mọi thao tác có thể tạo chi phí hoặc thay đổi hạ tầng phải đi qua bước review, dry-run/plan và nguyên tắc quyền tối thiểu. Không lưu secret trong Git.

## Code mẫu

- [Mở week08.sh](../code/week08.sh)
- Chạy: `bash code/week08.sh`
